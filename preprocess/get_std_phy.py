...
def get_mean(path):
    ...
    mean = np.load("/home/mafzhang/code/bioocean/constant/mean_phys.npy")


    stds= []
    for v in range(len(phy_vars)):
        var = phy_vars[v]
        daily= []
    ...
    np.save("/home/mafzhang/code/bioocean/constant/std_phys.npy", stds)
