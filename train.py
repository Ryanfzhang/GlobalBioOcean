...
train_dataset = GlorysDataset(nc_path=args.dataset_path)
...
for epoch in range(args.train_epochs):
    ...
    # for i, (x_phy, x_bio, time, land_mask, _) in tqdm(enumerate(train_dloader), total=len(train_dloader), disable=(not accelerator.is_local_main_process)):
